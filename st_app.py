...
global SHOW_POINTS_FACE ,SHOW_INFO,SHOW_CONVEX_HULL_FACE
...
def main():
    global SHOW_POINTS_FACE ,SHOW_INFO,SHOW_CONVEX_HULL_FACE,ear,mar,COUNTER_BLINK,COUNTER_FRAMES_EYE,COUNTER_MOUTH,COUNTER_FRAMES_MOUTH
    st.title("Real Time Driver Drowsiness System Using CV2")
    activities = ["Webcam", "Maps", "Manual", "Team"]
    icons1 = ['camera', 'map', 'gear', 'sun']

    st.sidebar.title("Setting")
    choice = st.sidebar.selectbox("Select Activity", activities)

    if choice=="Webcam":
        st.write("Switch on the webcam for detection")
    ...
    if choice=="Maps":
        st.title("Welcome to Navigation System")
