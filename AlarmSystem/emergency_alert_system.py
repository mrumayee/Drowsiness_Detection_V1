...
#   -----EMAIL ALERT SYSTEM-----
    msg=EmailMessage()
    msg.set_content(f'THIS IS A AUTOGENERATED EMAIL ALERT FOR YOU FROM DWIGHT: \n LOCATION: {locname.address}')
    msg['subject']='Emergency alert request from Dwight'
    recipients = ['pai.amogh@gmail.com', 'mrunmayee.m@somaiya.edu']
...
#     -----SMS ALERT SYSTEM------------
    message= f'THIS IS A AUTOGENERATED SMS ALERT FOR YOU FROM DWIGHT: \n LOCATION: {locname.address}'
...
#     -----Whatsapp message ---
    ...
    pywhatkit.sendwhatmsg("+919769309839",f'THIS IS A AUTOGENERATED WHATSAPP ALERT FOR YOU FROM DWIGHT: \n LOCATION: {locname.address}',
                          current_time.hour,
                          current_time.minute+1)
    pywhatkit.sendwhatmsg("+919987708622",f'THIS IS A AUTOGENERATED WHATSAPP ALERT FOR YOU FROM DWIGHT: \n LOCATION: {locname.address}',
                          current_time.hour,
